...
import kotlinx.android.synthetic.main.activity_etprofile.*
...
class EditProfileActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_etprofile)
        ...
        if (user != null){
            if (user.photoUrl != null){
                Picasso.get().load(user.photoUrl).into(etimage)
            }else{
                Picasso.get().load("https://picsum.photos/id/1002/4312/2868").into(etimage)
            }
            editprofile()
        }
    }
    ...
    private fun editprofile() {
        ...
        button6.setOnClickListener {
            ...
            val userData = User(etnama.text.toString(), button5.text.toString(), button3.text.toString() )
            ...
            userreference?.updateChildren(userData.getMap())!!.addOnSuccessListener {
                ...
                val intentprofile = Intent(this@EditProfileActivity, MainActivity::class.java)
            ...
            .addOnCompleteListener{
                if (it.isSuccessful){
                    ref.downloadUrl.addOnCompleteListener {
                        it.result?.let {
                            imageUri = it
                            etimage.setImageBitmap(imgBitmap)
                        }
                    }
                }
            }
